...
class CommonResponsiveUtils {
  ...
  /// 获取当前屏幕类型
  static CommonScreenType getScreenType(
    BuildContext context, {
    double phoneBreakpoint = defaultPhoneBreakpoint,
    double tabletBreakpoint = defaultTabletBreakpoint,
  }) {
    if (isMobile(context, phoneBreakpoint: phoneBreakpoint)) {
      return CommonScreenType.mobile;
    } else if (isTablet(
      context,
      phoneBreakpoint: phoneBreakpoint,
      tabletBreakpoint: tabletBreakpoint,
    )) {
      return CommonScreenType.tablet;
    } else {
      return CommonScreenType.desktop;
    }
  }
  ...
  static T responsive<T>(
    ...
    final CommonScreenType screenType = getScreenType(
      context,
      phoneBreakpoint: phoneBreakpoint,
      tabletBreakpoint: tabletBreakpoint,
    );
    ...
    switch (screenType) {
      case CommonScreenType.mobile:
        return mobile;
      case CommonScreenType.tablet:
        return tablet ?? mobile;
      case CommonScreenType.desktop:
